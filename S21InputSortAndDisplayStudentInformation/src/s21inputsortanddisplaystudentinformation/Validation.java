...
public class Validation {
    ...
    /**
     * Prompts the user for a double value within a specified range and returns
     * the value entered. If the user enters an invalid input or a value outside
     * the range, an error message is displayed and the user is prompted to
     * enter a new value.
     *
     * @param prompt the prompt to display to the user
    ...
    public static double getDouble(String prompt, double min, double max) {
        while (true) {
            ...
            try {
                double value = Double.parseDouble(scanner.nextLine()); // Read the input as a double
                if (value >= min && value <= max) { // Check if the value is within the specified range
                    ...
                    // Display an error message if the value is outside the specified range
                }
            } catch (NumberFormatException e) {
     ...
     */
    public static String getStringWhitespace(
